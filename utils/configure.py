...
RANK_TRAIN_DATA_PATH = 'data/rank/train.json'  # 验证提交，实际rank训练集
RANK_DEV_DATA_PATH = 'data/rank/dev.json'  # 验证提交，实际rank验证集

# 错误分析
ENTITY_ERROR_PATH = 'data/entity_error.json'  # 官方训练集中未能获得正确的entity的问题
